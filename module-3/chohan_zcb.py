...
Notice:
    If the player gets a 2 or a 7 total on a dice roll, they get a 10 mon bonus.
''')
...
while True:  # Main game loop.
    ...
    if totalDice == 2 or totalDice == 7:
        purse += 10
        print(f'Total roll was {totalDice}. You received a 10 mon bonus.')
